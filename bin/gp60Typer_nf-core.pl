...
#Modified: SSM 12-16-2024 for use with nf-core Nexflow
...
my $BlastOutput;
GetOptions ("fasta=s" => \$inFasta,
	"data=s" => \$SEQ_TYPE,
	"out=s" => \$OUT,
	"bns!" => \$BNS, #more coming soon
	"mepi!" => \$mepiFlag,
	"help!" => \$help,
	"blastresultsgp60=s" => \$BlastOutput)
or die usage();
...
"
  ...
  Usage: $0 --fasta sequences.fasta --blastresultgp60 blast.txt --data (sanger|wgs) [--other options]
  --fasta	A fasta file; can be gzipped.
  --blastresultsgp60	Text file of blast results.
